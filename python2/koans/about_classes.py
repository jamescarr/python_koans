...
class AboutClasses(Koan):
    ...
    def test_classes_have_docstrings(self):
        self.assertMatch(".*let them drive.", self.Dog.__doc__)
    ...
    def test_that_name_can_be_read_as_a_property(self):
        ...
        self.assertEqual("Fidos", fido.get_name())  # access as method
        self.assertEqual("Fidos", fido.name)        # access as property
    ...
    def test_creating_properties_with_decorators_is_slightly_easier(self):
        ...
        fido.name = "Fido"
        self.assertEqual("Fido21", fido.name)
